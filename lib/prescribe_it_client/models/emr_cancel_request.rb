...
module PrescribeItClient
  class EmrCancelRequest < BaseBundle
    ...
    def self.openapi_types
      {
        ...
        :'patient_info' => :'PatientInfo',
        :'practitioner' => :'Practitioner',
        :'cancel_requests' => :'Array<CancelMedicationOrder>',
        :'group_id' => :'Identifier'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        ...
        unless self.class.acceptable_attributes.include?(symbolized_key)
          fail ArgumentError, "`#{k}` is not a valid attribute in `PrescribeItClient::EmrCancelRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.acceptable_attributes.inspect
        end
        h[symbolized_key] = v
      }
    ...
    def hash
      [source, destination, patient_info, practitioner, cancel_requests, group_id].hash
    end

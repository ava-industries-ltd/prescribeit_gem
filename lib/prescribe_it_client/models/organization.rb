...
module PrescribeItClient
  class Organization < CommunicationEntity
    attr_accessor :id
    ...
    attr_accessor :parent_organization
    ...
    def self.openapi_types
      {
        :'id' => :'String',
        :'name' => :'String',
        :'organization_type' => :'SharedOrganizationTypeHolder',
        :'contact_list' => :'Array<ContactInfo>',
        :'address' => :'Address',
        :'services_offered' => :'Array<CommunicationService>',
        :'parent_organization' => :'OrganizationParentReference',
        :'last_updated' => :'Time'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `PrescribeItClient::Organization` initialize method"
      end

      attributes = attributes.each_with_object({}) { |(k, v), h|
        symbolized_key = k.to_sym
        unless self.class.acceptable_attributes.include?(symbolized_key)
          fail ArgumentError, "`#{k}` is not a valid attribute in `PrescribeItClient::Organization`. Please check the name to make sure it's valid. List of attributes: " + self.class.acceptable_attributes.inspect
        end
        h[symbolized_key] = v
      }
      ...
      if attributes.key?(:'parent_organization')
        self.parent_organization = attributes[:'parent_organization']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          last_updated == o.last_updated && super(o)
    end
    ...
    def hash
      [id, name, organization_type, contact_list, address, services_offered, parent_organization, last_updated].hash
    end

...
module PrescribeItClient
  class PmsRenewalRequest < BaseBundle
    ...
    def self.openapi_types
      {
        ...
        :'patient_info' => :'PatientInfo',
        :'practitioner' => :'Practitioner',
        :'notes_to_prescriber' => :'Array<String>',
        :'renewal_requests' => :'Array<RenewRequestMedicationOrder>',
        :'group_id' => :'Identifier'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        ...
        unless self.class.acceptable_attributes.include?(symbolized_key)
          fail ArgumentError, "`#{k}` is not a valid attribute in `PrescribeItClient::PmsRenewalRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.acceptable_attributes.inspect
        end
        h[symbolized_key] = v
      }
    ...
    def hash
      [source, destination, patient_info, practitioner, notes_to_prescriber, renewal_requests, group_id].hash
    end

    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        ...
        unless acceptable_attributes.include?(symbolized_key)
          fail ArgumentError, "`#{k}` is not a valid attribute in `PrescribeItClient::PatientContactInfo`. Please check the name to make sure it's valid. List of attributes: " + combined_attributes.keys.inspect
        end
        h[symbolized_key] = v
      }

    ...
    def self.openapi_types
      {
        ...
        :'trial_eligibility' => :'Object',
        :'fill_instruction' => :'Object',
        :'max_dispense' => :'Object',
        :'total_prescribed_quantity' => :'Object',
        :'total_days_supply' => :'Object',
        :'validity_period' => :'Object',
        :'number_of_repeats_allowed' => :'Object',
        :'quantity' => :'Object',
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `PrescribeItClient::MedicationOrderDispenseRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

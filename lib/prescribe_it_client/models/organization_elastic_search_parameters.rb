...
module PrescribeItClient
  class OrganizationElasticSearchParameters
    ...
    def self.openapi_types
      {
        :'role' => :'Object',
        :'address_state_exact' => :'Object',
        :'search_string' => :'Object',
        :'attribute_set' => :'Object',
        :'entity_service_code' => :'Object',
        :'include_all_practitioners' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `PrescribeItClient::OrganizationElasticSearchParameters`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

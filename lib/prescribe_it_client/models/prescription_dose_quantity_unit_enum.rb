...
module PrescribeItClient
  class PrescriptionDoseQuantityUnitEnum
    ...
    def build_from_hash(value)
      constantValues = PrescriptionDoseQuantityUnitEnum.constants.select { |c| PrescriptionDoseQuantityUnitEnum::const_get(c) == value }
      raise "Invalid ENUM value #{value} for class #PrescriptionDoseQuantityUnitEnum" if constantValues.empty?
      value
    end
  end
end

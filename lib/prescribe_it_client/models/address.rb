  ...
  class Address
    ...
    def self.openapi_types
      {
        ...
        :'city' => :'String',
        :'postal_code' => :'String',
        :'province' => :'CanadianJurisdictionHolder',
        :'country' => :'String',
        :'address_type' => :'AddressTypeHolder'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `PrescribeItClient::Address` initialize method"
      end

      attributes = attributes.each_with_object({}) { |(k, v), h|
        symbolized_key = k.to_sym
        unless self.class.acceptable_attributes.include?(symbolized_key)
          fail ArgumentError, "`#{k}` is not a valid attribute in `PrescribeItClient::Address`. Please check the name to make sure it's valid. List of attributes: " + self.class.acceptable_attributes.inspect
        end
        h[symbolized_key] = v
      }
    ...
    def hash
      [street, street2, city, postal_code, province, country, address_type].hash
    end

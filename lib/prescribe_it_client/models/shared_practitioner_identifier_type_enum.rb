...
module PrescribeItClient
  class SharedPractitionerIdentifierTypeEnum
    ...
    def build_from_hash(value)
      constantValues = SharedPractitionerIdentifierTypeEnum.constants.select { |c| SharedPractitionerIdentifierTypeEnum::const_get(c) == value }
      raise "Invalid ENUM value #{value} for class #SharedPractitionerIdentifierTypeEnum" if constantValues.empty?
      value
    end
  end
end

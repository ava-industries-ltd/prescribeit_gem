...
module PrescribeItClient
  class PmsAdaptRequest
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `PrescribeItClient::PmsAdaptRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [source, destination, patient_info, practitioner, pharmacist, adapt_order, group_id, bundle_id, bundle_full_url, timestamp, id, type].hash
    end

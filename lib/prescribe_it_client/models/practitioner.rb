...
module PrescribeItClient
  class Practitioner
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `PrescribeItClient::Practitioner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [id, token, communication, license_number, contact_list, role, specialty, services_offered, organizations, first_name, middle_name, last_name, name_prefix, name_suffix, entity_type].hash
    end

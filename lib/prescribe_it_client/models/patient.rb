  ...
  class Patient
    ...
    def self.openapi_types
      {
        ...
        :'gender' => :'Object',
        :'address' => :'Object',
        :'local_patient_identifier' => :'Object',
        :'jurisdictional_health_number' => :'Object',
        :'phones' => :'Object',
        :'other_names' => :'Object',
        :'first_name' => :'Object',
        :'middle_name' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `PrescribeItClient::Patient` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `PrescribeItClient::Patient`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

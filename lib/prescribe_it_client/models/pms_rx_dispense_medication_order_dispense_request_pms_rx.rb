    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        ...
        unless self.class.acceptable_attributes.include?(symbolized_key)
          fail ArgumentError, "`#{k}` is not a valid attribute in `PrescribeItClient::PmsRxDispenseMedicationOrderDispenseRequestPmsRx`. Please check the name to make sure it's valid. List of attributes: " + self.class.acceptable_attributes.inspect
        end
        h[symbolized_key] = v
      }
      ...
      if attributes.key?(:'expected_supply_duration_days')
        ...
        self.expected_supply_duration_days = nil
      end
    end

  ...
  class BaseMedicationOrder
    ...
    def self.openapi_types
      {
        ...
        :'dispense_request' => :'MedicationOrderDispenseRequest',
        :'medication_info' => :'MedicationInfo',
        ...
        :'task_id' => :'String',
        :'prior_prescription_id' => :'Identifier',
        :'type' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `PrescribeItClient::BaseMedicationOrder` initialize method"
      end

      attributes = attributes.each_with_object({}) { |(k, v), h|
        symbolized_key = k.to_sym
        unless self.class.acceptable_attributes.include?(symbolized_key)
          fail ArgumentError, "`#{k}` is not a valid attribute in `PrescribeItClient::BaseMedicationOrder`. Please check the name to make sure it's valid. List of attributes: " + self.class.acceptable_attributes.inspect
        end
        h[symbolized_key] = v
      }
    ...
    def hash
      [id, dosage_instructions, dispense_request, medication_info, rendered_dosage_instruction, dis_ids, treatment_type, category, detected_issues, pharmacy_instructions, over25dur, monitored_drug, no_renewals, reason_codes, note, date_written, is_high_priority, do_not_autofill, task_id, prior_prescription_id, type].hash
    end

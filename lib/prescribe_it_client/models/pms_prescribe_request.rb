...
module PrescribeItClient
  class PmsPrescribeRequest < BaseBundle
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        ...
        unless self.class.acceptable_attributes.include?(symbolized_key)
          fail ArgumentError, "`#{k}` is not a valid attribute in `PrescribeItClient::PmsPrescribeRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.acceptable_attributes.inspect
        end
        h[symbolized_key] = v
      }
      ...
      if attributes.key?(:'pharmacy_medication_order')
        ...
        self.pharmacy_medication_order = nil
      end
    ...
    def hash
      [source, destination, patient_info, practitioner, pharmacist, pharmacy_medication_order, group_id].hash
    end

...
module PrescribeItClient
  class EmrDeferredRequest < BaseBundle
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        ...
        unless self.class.acceptable_attributes.include?(symbolized_key)
          fail ArgumentError, "`#{k}` is not a valid attribute in `PrescribeItClient::EmrDeferredRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.acceptable_attributes.inspect
        end
        h[symbolized_key] = v
      }
    ...
    def hash
      [source, patient_info, practitioner, deferred_requests, group_id].hash
    end

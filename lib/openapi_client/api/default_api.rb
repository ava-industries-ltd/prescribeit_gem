...
module OpenapiClient
  class DefaultApi
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [PmsReturnDeferredQueryParameters] :pms_return_deferred_query_parameters 
    # @return [TransportResponse]
    def pms_return_deferred_post(opts = {})
      data, _status_code, _headers = pms_return_deferred_post_with_http_info(opts)
      data
    end
    ...
    # @option opts [PmsReturnDeferredQueryParameters] :pms_return_deferred_query_parameters 
    # @return [Array<(TransportResponse, Integer, Hash)>] TransportResponse data, response status code and response headers
    def pms_return_deferred_post_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DefaultApi.pms_return_deferred_post ...'
      end
      # resource path
      local_var_path = '/pms/return-deferred'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'pms_return_deferred_query_parameters'])
      ...
      new_options = opts.merge(
        :operation => :"DefaultApi.pms_return_deferred_post",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DefaultApi#pms_return_deferred_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end

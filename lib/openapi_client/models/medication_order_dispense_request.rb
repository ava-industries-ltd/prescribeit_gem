...
module OpenapiClient
  class MedicationOrderDispenseRequest
    ...
    attr_accessor :end_of_validity

    attr_accessor :is_for_life
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::MedicationOrderDispenseRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::MedicationOrderDispenseRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'end_of_validity')
        self.end_of_validity = attributes[:'end_of_validity']
      end

      if attributes.key?(:'is_for_life')
        self.is_for_life = attributes[:'is_for_life']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          end_of_validity == o.end_of_validity &&
          is_for_life == o.is_for_life
    end
    ...
    def hash
      [dispense_interval_days, trial_eligibility, fill_instruction, max_dispense, total_prescribed_quantity, total_days_supply, validity_period, number_of_repeats_allowed, quantity, expected_supply_duration_days, end_of_validity, is_for_life].hash
    end

...
# Unit tests for OpenapiClient::EmrFormularyRequestQuery
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::EmrFormularyRequestQuery do
  let(:instance) { OpenapiClient::EmrFormularyRequestQuery.new }

  describe 'test an instance of EmrFormularyRequestQuery' do
    it 'should create an instance of EmrFormularyRequestQuery' do
      expect(instance).to be_instance_of(OpenapiClient::EmrFormularyRequestQuery)
    end
  end

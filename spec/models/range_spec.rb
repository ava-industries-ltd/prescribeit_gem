...
# Unit tests for PrescribeItClient::Range
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PrescribeItClient::Range do
  let(:instance) { PrescribeItClient::Range.new }

  describe 'test an instance of Range' do
    it 'should create an instance of Range' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(PrescribeItClient::Range)
    end
  end

...
# Unit tests for PrescribeItClient::Address
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PrescribeItClient::Address do
  let(:instance) { PrescribeItClient::Address.new }

  describe 'test an instance of Address' do
    it 'should create an instance of Address' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(PrescribeItClient::Address)
    end
  end
